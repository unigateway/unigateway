...
class MulticastDnsServiceDiscoveryControllerTest extends MqttSpecification {
  ...
  def "should receive a list of other Unigateway in the local network"() {
    given:
    ...
    jmDnsStub.handleServiceResolved("_unigateway._tcp.local.", "gateway1", 7777, "192.168.6.101")
    jmDnsStub.handleServiceResolved("_unigateway._tcp.local.", "gateway2", 8888, "192.168.6.102")
    jmDnsStub.handleServiceResolved("_unigateway._tcp.local.", "gateway3", 9999, "192.168.6.103")
