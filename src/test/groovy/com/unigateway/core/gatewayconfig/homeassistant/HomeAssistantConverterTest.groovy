...
import static com.unigateway.core.device.DevicePropertyType.IP_ADDRESS
import static com.unigateway.core.device.DevicePropertyType.MEMORY
import static com.unigateway.core.device.DevicePropertyType.POSITION
import static com.unigateway.core.device.DevicePropertyType.STATE
import static com.unigateway.core.device.DevicePropertyType.TEMPERATURE
import static com.unigateway.core.device.DevicePropertyType.UPTIME
...
class HomeAssistantConverterTest extends Specification {
  ...
  def "should convert Unigateway relay to HA light when set explicitly in gateway configuration"() {
    given:
    ...
    when:
    def components = converter.convert(deviceRegistry).findAll { isNotFromUnigatewayCore(it, gateway) }
  ...
  def "should convert Unigateway relay to HA switch when haComponent not set explicitly in gateway configuration"() {
    given:
    def relayDeviceConfig = new DeviceConfiguration("myRelay", "Test relay", DeviceType.RELAY, [state: new SimulatedConnector(1)])
  ...
  def "should convert Unigateway SWITCH_BUTTON to 4 HA triggers when haComponent is set to 'device_automation'"() {
    given:
  ...
  def "should convert Unigateway SWITCH_BUTTON to sensor when haComponent is set to 'sensor'"() {
    given:
    def switchButtonDeviceConfig = new DeviceConfiguration("mySwitchButton", "Test button", DeviceType.SWITCH_BUTTON,
  ...
  def "should convert Unigateway SWITCH_BUTTON to binary sensor when haComponent is not set"() {
    given:
    def switchButtonDeviceConfig = new DeviceConfiguration("mySwitchButton", "Test button", DeviceType.SWITCH_BUTTON,
  ...
  def "should convert Unigateway REED_SWITCH to HA binary sensor"() {
    given:
  ...
  def "should convert Unigateway MOTION_DETECTOR to HA binary sensor"() {
    given:
  ...
  def "should convert Unigateway EMULATED_SWITCH to HA switch"() {
    given:
  ...
  def "should convert Unigateway SHUTTER to HA cover"() {
    given:
  ...
  @Ignore("Requires implementation of GateDevice factory") // todo add task for this and for readme
  def "should convert Unigateway GATE to HA cover"() {
    given:
  ...
  def "should convert Unigateway device to 6 HA sensors"() {
    given:
  ...
  static boolean isNotFromUnigatewayCore(HomeAssistantComponent component, GatewayConfiguration gateway) {
