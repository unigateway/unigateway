...
class GatewayServerWebSocket(private val gatewayDeviceRegistry: DeviceRegistry, private val devicesStateHandler: GatewayDevicesStateHandler) {
  ...
  @OnMessage
  fun onMessage(clientId: String, message: DeviceChangeMessage, session: WebSocketSession): Publisher<MessageWrapper<String>> {
  ...
  data class DeviceChangeMessage @JsonCreator constructor(val deviceId: String, val propertyId: String, val newValue: String)
