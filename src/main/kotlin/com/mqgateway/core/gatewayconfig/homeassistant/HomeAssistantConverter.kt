  ...
  private fun toHomeAssistantComponents(
    ...
    val components = when (device.type) {
      ...
      DeviceType.RELAY -> {
        ...
        if (device.config[DEVICE_CONFIG_HA_COMPONENT].equals(HomeAssistantComponentType.LIGHT.value, true)) {
          ...
          device.config[DEVICE_CONFIG_HA_COMPONENT].equals(HomeAssistantComponentType.TRIGGER.value, true) -> {
            listOf(
              HomeAssistantTrigger(
                ...
                HomeAssistantTrigger.TriggerType.BUTTON_SHORT_PRESS,
                "button"
              ),
              HomeAssistantTrigger(
                ...
                HomeAssistantTrigger.TriggerType.BUTTON_SHORT_RELEASE,
                "button"
              ),
              HomeAssistantTrigger(
                ...
                HomeAssistantTrigger.TriggerType.BUTTON_LONG_PRESS,
                "button"
              ),
              HomeAssistantTrigger(
                ...
                HomeAssistantTrigger.TriggerType.BUTTON_LONG_RELEASE,
                "button"
              )
            )
          }
      ...
      DeviceType.GATE -> listOf(
        HomeAssistantCover(
          ...
          null,
          null,
          if (device.config[DEVICE_CONFIG_HA_DEVICE_CLASS].equals(HomeAssistantCover.DeviceClass.GATE.name, true))
            HomeAssistantCover.DeviceClass.GATE else HomeAssistantCover.DeviceClass.GARAGE,
