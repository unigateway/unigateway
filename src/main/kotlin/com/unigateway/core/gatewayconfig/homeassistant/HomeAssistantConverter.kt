...
import com.unigateway.core.device.gate.GateDevice
import com.unigateway.core.device.motiondetector.MotionSensorDevice
import com.unigateway.core.device.reedswitch.ReedSwitchDevice
import com.unigateway.core.device.relay.RelayDevice
import com.unigateway.core.device.shutter.ShutterDevice
import com.unigateway.core.device.switchbutton.SwitchButtonDevice
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantComponentType.LIGHT
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantCover.DeviceClass
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantTrigger.TriggerType.BUTTON_LONG_PRESS
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantTrigger.TriggerType.BUTTON_LONG_RELEASE
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantTrigger.TriggerType.BUTTON_SHORT_PRESS
import com.unigateway.core.gatewayconfig.homeassistant.HomeAssistantTrigger.TriggerType.BUTTON_SHORT_RELEASE
import com.unigateway.homie.HOMIE_PREFIX
...
class HomeAssistantConverter(private val gatewayFirmwareVersion: String) {
  ...
  fun convert(deviceRegistry: DeviceRegistry): List<HomeAssistantComponent> {
    ...
    val unigatewayCoreComponents = convertUnigatewayRootDeviceToHaSensors(uniGatewayDevice)

    val unigatewayId = uniGatewayDevice.id
    return unigatewayCoreComponents + devices.flatMap { device ->
  ...
  private fun toHomeAssistantComponents(
    ...
    val components = when (device.type) {
      ...
      DeviceType.UNIGATEWAY -> throw IllegalArgumentException("Unigateway should not be configured as a device")
    }
  ...
  private fun convertUnigatewayRootDeviceToHaSensors(unigatewayDevice: Device): List<HomeAssistantSensor> {
    val unigatewayId = unigatewayDevice.id
